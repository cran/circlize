...
###################################################
### code chunk number 1: figcorrelation1 (eval = FALSE)
###################################################
## par(mfrow = c(2, 1))


###################################################
### code chunk number 2: figcorrelation2 (eval = FALSE)
###################################################
## set.seed(12345)
## n = 9
...
###################################################
### code chunk number 3: figcorrelation3 (eval = FALSE)
###################################################
## xlim = cbind(rep(0, n), apply(m2, 2, function(x) sum(abs(x)) - 1))


###################################################
### code chunk number 4: figcorrelation4 (eval = FALSE)
###################################################
## library(circlize)
## factors = rownames(m2)
## colors = 1:n
...
###################################################
### code chunk number 5: figcorrelation5 (eval = FALSE)
###################################################
## rn = rownames(m2)
...
###################################################
### code chunk number 6: figcorrelation6 (eval = FALSE)
###################################################
...
###################################################
### code chunk number 7: figcorrelation
###################################################
par(mfrow = c(2, 1))
set.seed(12345)
n = 9
