...
###################################################
### code chunk number 1: figideogram
###################################################
library(circlize)
...
###################################################
### code chunk number 2: figideogram
###################################################
library(circlize)
circos.initializeWithIdeogram()
circos.link(sector.index1 = "chr2", point1 = 111111111, sector.index2 = "chr16", point2 = 55555555)
...
###################################################
### code chunk number 3: figgenomic
###################################################
library(circlize)
set.seed(12345)
...
###################################################
### code chunk number 4: figgenomic
###################################################
library(circlize)
set.seed(12345)
